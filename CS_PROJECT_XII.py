...
if __name__ == "__main__":
    def show_loading_screen():
        ...
        splash_root = tk.Tk()
        splash_root.title("Screen Time Tracker")
        window_width = 500
        window_height = 425
        ...
        splash_root.iconphoto(False, photo)
 ...
 #tt
   ...
   #Start and Stop
    ...
    start_button.place(x=900,y=200)
